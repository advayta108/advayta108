# Contributing to advayta108/advayta108

Thank you for investing your time in improving `advayta108/advayta108`. This document describes the recommended workflow for reporting issues, proposing enhancements, and submitting pull requests.
...
1. **Fork the repository**
   ```bash
   git clone https://github.com/advayta108/advayta108.git
   cd advayta108
   ```
...
6. **Push and open a Pull Request**
   ...
   ```
Then create a PR against `main` on [GitHub](https://github.com/advayta108/advayta108/pulls) and fill in the template.
...
```bash
 git remote add upstream https://github.com/advayta108/advayta108.git
git fetch upstream
git switch main
